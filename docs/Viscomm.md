...
The goal is not for you to understand every technical detail immediately, but rather to help you build a mental model of the system architecture. Once you understand the structure, the codebase becomes much easier to navigate and work with.
...
Telemetry Communication Pipeline(The Less Important One)
