...
void main() {
    ...
    vec3 blendedColor = mix(texColor.rgb, baseColor, barMask * texColor.a);

    // Output the final color with the overlay mask alpha
    fragColor = vec4(blendedColor, barMask * texColor.a);
