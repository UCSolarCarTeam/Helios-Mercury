...
Item {
    ...
    Image {
        id: motor0ErrorWarningDebugClusterFrameBackground
        x: 1
        y: 2
    ...
    Image {
        id: motor0ErrorWarningDebugClusterFrameOutline
        anchors.fill: parent
    ...
    Text {
        id: motor0WarningLabel
        color: Config.fontColor
        font.family: Config.fontStyle
        anchors {
            right: motor0ErrorWarningDebugClusterDebugCluster.right
            rightMargin: 350
            top: motor0ErrorWarningDebugClusterDebugCluster.top
            topMargin: 35
        }
        text: "Motor 0 Errors"
        font.pixelSize: Config.debugHeaderFontSize
